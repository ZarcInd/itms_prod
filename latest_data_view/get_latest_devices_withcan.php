...
if ($result->num_rows > 0) {
    echo "<table border='1'>
            <tr>
                ...
                <th>Packets Received(VTS+CAN) (Today)</th>
                <th>Active Hours</th>
...
//<th>Efficiency (%)</th>
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // Calculate expected packets (1 packet every 4 seconds → 900 packets per hour)
        $expected_packets = round($active_hours * 900); 
